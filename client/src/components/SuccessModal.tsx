import {
   Modal, ModalOverlay, ModalContent, Text, ModalBody,
   ModalProps, Button, Flex, ModalCloseButton
         ...
         <ModalContent py='30px'>
            ...
            <ModalBody>
               <Flex alignItems='center'
                  justifyContent='center' w='full' direction='column'>
                  <Text variant='notoSan' fontSize='12px' mt='10px'>
                     {title}
                  </Text>
